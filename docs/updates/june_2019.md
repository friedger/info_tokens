...
ThreeFold Grid Capacity is a "self-driving" (autonomous) , and can be sold to the grid similar to the way we can sell back solar energy to the grid.

ThreeFold Token is the medium to buy and sell decentralized internet capacity on ThreeFold Grid and is backed by the fastest growing commodity, the internet.  
...
- To be launched in the new wallet release in upcoming monthsQ3, 2019.;
...
### NBH Digital Wallet: 
- Decentralized alternative banking wallet to be released in Q3, 2019.
