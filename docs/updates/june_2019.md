...
ThreeFold Token is the medium to buy and sell, autonomous and decentralized internet capacity on the ThreeFold Grid and is backed by hardware added by farmers on the network.
...
Our plan for liquidity relies on driving the usage of the ThreeFold Token for real and demanded applications and use cases. For a year now our farmers have been deploying hardware (10x more hardware compared to the sum of all blockchain companies), forging strategic partnerships and now we are ready to show what we have done.  Please take a look at our growing ecosystem community. 
...
### Forex Market (New):
- NBH Markets will connect TFT and Forex market; buy and sell will be enabled over the summer on their platform.
