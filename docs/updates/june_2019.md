...
Internet & data capacity is the new gold of our digital economy. There is a +trillion dollar challenge currently facing the ICT world on how to meet this exponentially growing demand based on growing requirements for Edge Computing, AI and IOT. 
ThreeFold has provided a scalable answer to this global challenge. Its a global network of decentralized internet capacity thats is autonomous managed. A "self-driving" driving internet grid. This enables current cloud services as well as other blockchain protocols to scale beyond the limitations (complexity and scalability) of current ICT solutions. 
ThreeFold Token is the medium to buy and sell decentralized internet capacity on ThreeFold Grid and is backed by hardware on the network.ThreeFold Token is a token of the future internet, it’s where the internet is headed, closer to the user and to the edge.
...
**March 2018**:  TF Tokens launched in March 2018 at 0.10 dollar cents, first farmers join the grid
...
Our plan for liquidity relies on driving the usage of the ThreeFold Token for real and demanded applications and use cases. For over 2 years we have been working on our technology, deploying hardware (10x market comparison), forging strategic partnerships and now we are ready to show what we have done.  Please take a look at our growing ecosystem community. 
...
**[Andrew Zapotochnyi](https://www.linkedin.com/in/zapotochnyi/) - New ThreeFold Grid Marketing Lead**

Andrew  is an experienced marketeer, founder of [CoinPRKit.io](https://coinprkit.io/), led successful marketing campaigns for multiple blockchain projects. Now he is part of ThreeFold Team. His first task is to rework and simplify our messaging and communication and help to align our long-term marketing strategy.
